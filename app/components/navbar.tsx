...
export default function Navbar() {
  ...
  return (
    <nav className="relative z-50 flex h-16 w-full shrink-0 items-center border-b border-[#24aa4d]/35 bg-gradient-to-r from-[#010806] via-[#071910] to-[#03140c] shadow-[inset_0_-1px_0_0_rgba(36,170,77,0.12)] md:h-20">
      <div className="relative mx-auto flex w-full max-w-[1440px] items-center justify-between px-4 sm:px-6 md:px-8">
        <span
          className="pointer-events-none absolute left-1/2 top-1/2 z-10 max-w-[min(240px,50vw)] -translate-x-1/2 -translate-y-1/2 truncate text-center text-sm font-semibold tracking-wide text-[#24aa4d] sm:max-w-md sm:text-base"
          aria-hidden
        >
          Ip application demo
        </span>
        ...
        <div className="relative z-20 flex items-center gap-3 md:gap-4">
          <button
